...
.menu__dropdown::after {
  content: "";
  background: url("/images/icons/select-chevron.svg") no-repeat center center;
...
.menu__dropdown-item:hover a::after {
  width: 100%;
}
